...
namespace Octopus.Cli.Commands.Runbooks
{
    ...
    public class RunRunbookCommand : ApiCommand, ISupportFormattedOutput
    {
        ...
        private RunbookRunResource[] Response { get; set; }
        ...
        private List<string> EnvironmentNamesOrIds { get; set; } = new List<string>();
            ...
            repositoryFactory, fileSystem, commandOutputProvider)
        {
            ...
            options.Add<string>("runbookNameOrId=", // TODO can't we use the 
