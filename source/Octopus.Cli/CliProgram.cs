    ...
    public class CliProgram
    {
        ...
        static int PrintError(Exception ex)
        {
            ...
            if (cmd != null)
            {
                ...
                {
                    Log.Error("This error is most likely occurring while executing octo as part of an automated build process. The following doc is recommended to get some tips on how to troubleshoot this: https://g.octopushq.com/OctoexeTroubleshooting");
                }
                return -1;
            }
